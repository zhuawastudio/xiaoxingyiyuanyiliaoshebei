...
public class ShebeichurukuView extends ShebeichurukuEntity implements Serializable {
	...
	*/
	...
	private String shebeichurukuValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String shebeichurukuYesnoValue;
	...
	public ShebeichurukuView() {

	}

	public ShebeichurukuView(ShebeichurukuEntity shebeichurukuEntity) {
		try {
			BeanUtils.copyProperties(this, shebeichurukuEntity);
	...
	* 获取： 出入库类型的值
	*/
	public String getShebeichurukuValue() {
		return shebeichurukuValue;
	}
	/**
	* 设置： 出入库类型的值
	*/
	public void setShebeichurukuValue(String shebeichurukuValue) {
		this.shebeichurukuValue = shebeichurukuValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getShebeichurukuYesnoValue() {
		return shebeichurukuYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setShebeichurukuYesnoValue(String shebeichurukuYesnoValue) {
		this.shebeichurukuYesnoValue = shebeichurukuYesnoValue;
	}
	...
	public String toString() {
		return "ShebeichurukuView{" +
			", shebeichurukuValue=" + shebeichurukuValue +
			", shebeichurukuYesnoValue=" + shebeichurukuYesnoValue +
