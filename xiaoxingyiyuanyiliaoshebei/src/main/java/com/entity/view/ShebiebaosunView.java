...
public class ShebiebaosunView extends ShebiebaosunEntity implements Serializable {
	...
	*/
	...
	private String shebiebaosunYesnoValue;
	...
	public ShebiebaosunView() {

	}

	public ShebiebaosunView(ShebiebaosunEntity shebiebaosunEntity) {
		try {
			BeanUtils.copyProperties(this, shebiebaosunEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getShebiebaosunYesnoValue() {
		return shebiebaosunYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setShebiebaosunYesnoValue(String shebiebaosunYesnoValue) {
		this.shebiebaosunYesnoValue = shebiebaosunYesnoValue;
	}
	...
	public String toString() {
		return "ShebiebaosunView{" +
			", shebiebaosunYesnoValue=" + shebiebaosunYesnoValue +
