...
public class ShebieweixiuView extends ShebieweixiuEntity implements Serializable {
	...
	*/
	...
	private String shebieweixiuYesnoValue;
	...
	public ShebieweixiuView() {

	}

	public ShebieweixiuView(ShebieweixiuEntity shebieweixiuEntity) {
		try {
			BeanUtils.copyProperties(this, shebieweixiuEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getShebieweixiuYesnoValue() {
		return shebieweixiuYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setShebieweixiuYesnoValue(String shebieweixiuYesnoValue) {
		this.shebieweixiuYesnoValue = shebieweixiuYesnoValue;
	}
	...
	public String toString() {
		return "ShebieweixiuView{" +
			", shebieweixiuYesnoValue=" + shebieweixiuYesnoValue +
