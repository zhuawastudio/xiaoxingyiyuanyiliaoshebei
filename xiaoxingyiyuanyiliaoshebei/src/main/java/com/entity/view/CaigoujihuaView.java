...
public class CaigoujihuaView extends CaigoujihuaEntity implements Serializable {
	...
	*/
	...
	private String caigoujihuaYesnoValue;
	...
	* 获取： 申请状态的值
	*/
	public String getCaigoujihuaYesnoValue() {
		return caigoujihuaYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setCaigoujihuaYesnoValue(String caigoujihuaYesnoValue) {
		this.caigoujihuaYesnoValue = caigoujihuaYesnoValue;
	}
	...
	public String toString() {
		return "CaigoujihuaView{" +
			", caigoujihuaYesnoValue=" + caigoujihuaYesnoValue +
