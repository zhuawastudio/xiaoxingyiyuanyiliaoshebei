...
public class ShebiejianceView extends ShebiejianceEntity implements Serializable {
	...
	*/
	...
	private String shebiejianceYesnoValue;
	...
	public ShebiejianceView() {

	}

	public ShebiejianceView(ShebiejianceEntity shebiejianceEntity) {
		try {
			BeanUtils.copyProperties(this, shebiejianceEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getShebiejianceYesnoValue() {
		return shebiejianceYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setShebiejianceYesnoValue(String shebiejianceYesnoValue) {
		this.shebiejianceYesnoValue = shebiejianceYesnoValue;
	}
	...
	public String toString() {
		return "ShebiejianceView{" +
			", shebiejianceYesnoValue=" + shebiejianceYesnoValue +
