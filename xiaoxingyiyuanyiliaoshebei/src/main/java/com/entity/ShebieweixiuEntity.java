...
public class ShebieweixiuEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShebieweixiuEntity() {

	}

	public ShebieweixiuEntity(T t) {
		try {
     ...
     * 维修数量
     */
    @ColumnInfo(comment="维修数量",type="int(11)")
    ...
    public String toString() {
        return "Shebieweixiu{" +
            ...
            ", shebeiId=" + shebeiId +
            ", yonghuId=" + yonghuId +
            ", shebieweixiuNumber=" + shebieweixiuNumber +
            ", shebieweixiuText=" + shebieweixiuText +
            ", shebieweixiuYesnoTypes=" + shebieweixiuYesnoTypes +
            ", shebieweixiuYesnoText=" + shebieweixiuYesnoText +
