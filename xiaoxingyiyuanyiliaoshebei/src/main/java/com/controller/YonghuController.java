    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者职员手机号或者职员身份证号已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuName(data.get(0));                    //职员名称 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //职员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //职员身份证号 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setKeshiTypes(Integer.valueOf(data.get(0)));   //科室 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //职员邮箱 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [职员手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //职员身份证号
                        ...
                        if(yonghuEntities_yonghuIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [职员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "科室职员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","科室职员");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者职员手机号或者职员身份证号已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setInsertTime(new Date());
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
